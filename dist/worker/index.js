...
Check the top-level render call using <` + parentName + ">.");
      ...
      exports.Children = Children2, exports.Component = Component2, exports.Fragment = REACT_FRAGMENT_TYPE, exports.Profiler = REACT_PROFILER_TYPE, exports.PureComponent = PureComponent, exports.StrictMode = REACT_STRICT_MODE_TYPE, exports.Suspense = REACT_SUSPENSE_TYPE, exports.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = ReactSharedInternals, exports.cloneElement = cloneElement$1, exports.createContext = createContext4, exports.createElement = createElement$1, exports.createFactory = createFactory, exports.createRef = createRef, exports.forwardRef = forwardRef4, exports.isValidElement = isValidElement2, exports.lazy = lazy2, exports.memo = memo, exports.startTransition = startTransition, exports.unstable_act = act, exports.useCallback = useCallback3, exports.useContext = useContext6, exports.useDebugValue = useDebugValue, exports.useDeferredValue = useDeferredValue, exports.useEffect = useEffect5, exports.useId = useId, exports.useImperativeHandle = useImperativeHandle, exports.useInsertionEffect = useInsertionEffect, exports.useLayoutEffect = useLayoutEffect3, exports.useMemo = useMemo9, exports.useReducer = useReducer, exports.useRef = useRef3, exports.useState = useState5, exports.useSyncExternalStore = useSyncExternalStore, exports.useTransition = useTransition2, exports.version = ReactVersion, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    })();
  }
});
...
function matchRouteBranch(branch, pathname) {
  ...
  for (let i = 0; i < routesMeta.length; ++i) {
    let meta3 = routesMeta[i], end = i === routesMeta.length - 1, remainingPathname = matchedPathname === "/" ? pathname : pathname.slice(matchedPathname.length) || "/", match = matchPath({
...
__export(dist_exports, {
  ...
  UNSAFE_startTransitionImpl: () => startTransitionImpl,
...
var React, START_TRANSITION, startTransitionImpl, DataRouterContext, DataRouterStateContext, AwaitContext, NavigationContext, LocationContext, RouteContext, RouteErrorContext, navigateEffectWarning, OutletContext, defaultErrorElement, RenderErrorBoundary, DataRouterHook, DataRouterStateHook, blockerId, alreadyWarned, AwaitRenderStatus, neverSettledPromise, AwaitErrorBoundary, init_dist = __esm({
  "node_modules/react-router/dist/index.js"() {
    ...
    init_router();
    init_router();
    START_TRANSITION = "startTransition", startTransitionImpl = React[START_TRANSITION], DataRouterContext = /* @__PURE__ */ React.createContext(null);
...
var React2, defaultMethod, defaultEncType, _excluded, _excluded2, _excluded3, isBrowser, ABSOLUTE_URL_REGEX2, Link, NavLink, Form, FormImpl, DataRouterHook2, DataRouterStateHook2, fetcherId, SCROLL_RESTORATION_STORAGE_KEY, savedScrollPositions, init_dist2 = __esm({
  "node_modules/react-router-dom/dist/index.js"() {
...
function V1Meta() {
  let {
    ...
    matches: routerMatches,
    loaderData
  } = useDataRouterStateContext(), location = useLocation(), matches = errors ? routerMatches.slice(0, routerMatches.findIndex((m) => errors[m.route.id]) + 1) : routerMatches, meta3 = {}, parentsData = {};
  for (let match of matches) {
...
function V2Meta() {
  let {
    ...
    matches: routerMatches,
    loaderData
  } = useDataRouterStateContext(), location = useLocation(), _matches = errors ? routerMatches.slice(0, routerMatches.findIndex((m) => errors[m.route.id]) + 1) : routerMatches, meta3 = [], leafMeta = null, matches = [];
...
To reference the v1 meta function API, see https://remix.run/route/meta`);
    match.meta = routeMeta, matches[i] = match, meta3 = [...routeMeta], leafMeta = meta3;
  }
...
function Layout({ children, title }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex flex-col min-h-screen antialiased bg-neutral-50", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(
      "header",
      {
        role: "banner",
        className: "flex items-center h-16 p-6 md:p-8 lg:p-12 sticky backdrop-blur-lg z-40 top-0 justify-between w-full leading-none gap-4 antialiased transition shadow-sm",
        children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("div", { className: "flex gap-12", children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("a", { className: "font-bold", href: "/", children: title }, void 0, !1, {
...
function createStorefrontClient(props) {
  ...
  let isMockShop = (domain) => domain.includes("mock.shop"), getShopifyDomain = (overrideProps) => {
...
}, ShopifyContext = (0, import_react3.createContext)(
...
var Image = React7.forwardRef(
  ({
    ...
    let normalizedData = React7.useMemo(() => {
      let dataWidth = data != null && data.width && (data != null && data.height) ? data == null ? void 0 : data.width : void 0, dataHeight = data != null && data.width && (data != null && data.height) ? data == null ? void 0 : data.height : void 0;
      return {
        width: dataWidth,
        height: dataHeight,
        unitsMatch: Boolean(unitsMatch(dataWidth, dataHeight))
      };
    }, [data]), normalizedProps = React7.useMemo(() => {
      let widthParts = getUnitValueParts((width || "100%").toString()), nWidth = `${widthParts.number}${widthParts.unit}`, autoHeight = height == null, heightParts = autoHeight ? null : getUnitValueParts(height.toString()), fixedHeight = heightParts ? `${heightParts.number}${heightParts.unit}` : "", nHeight = autoHeight ? "auto" : fixedHeight, nSrc = src || (data == null ? void 0 : data.url);
      nSrc || console.warn(
        "No src or data.url provided to Image component.",
        (passthroughProps == null ? void 0 : passthroughProps.key) || ""
      );
      let nAlt = data != null && data.altText && !alt ? data == null ? void 0 : data.altText : alt || "", nAspectRatio = aspectRatio || (normalizedData.unitsMatch ? [
...
function FixedWidthImage({
  ...
  }, [aspectRatio, crop, height, imageWidths, loader6, normalizedProps, width]);
...
async function setItem(cache, request, response, userCacheOptions) {
  ...
  response.headers.set("cache-control", cacheControlString), response.headers.set("real-cache-control", cacheControlString), response.headers.set("cache-put-date", (/* @__PURE__ */ new Date()).toUTCString()), request.url, await cache.put(request, response);
}
...
function isStale(request, response) {
  ...
  if (!responseDate)
    return !1;
  let result = ((/* @__PURE__ */ new Date()).valueOf() - new Date(responseDate).valueOf()) / 1e3 > responseMaxAge;
...
}, LIB_VERSION = "2023.4.6", StorefrontApiError = class extends Error {
...
}, ERROR_PREFIX = "Error in SEO input: ", schema = {
  title: {
    validate: (value) => {
...
function generateSeoTags(seoInput) {
  let tagResults = [];
  for (let seoKey of Object.keys(seoInput))
    switch (seoKey) {
      case "title": {
        let content = validate(schema.title, seoInput.title), title = renderTitle(seoInput == null ? void 0 : seoInput.titleTemplate, content);
        if (!title)
          break;
        tagResults.push(
      ...
      case "description": {
        let content = validate(schema.description, seoInput.description);
        if (!content)
          break;
        tagResults.push(
          generateTag("meta", {
      ...
      case "url": {
        let content = validate(schema.url, seoInput.url);
        if (!content)
          break;
        tagResults.push(
          generateTag("link", {
      ...
      case "handle": {
        let content = validate(schema.handle, seoInput.handle);
        if (!content)
          break;
        tagResults.push(
      ...
      case "media": {
        let content, values = ensureArray(seoInput.media);
      ...
      case "jsonLd": {
        let jsonLdBlocks = ensureArray(seoInput.jsonLd), index = 0;
      ...
      case "alternates": {
        let alternates = ensureArray(seoInput.alternates);
...
function generateKey(tag, group) {
  let { tag: tagName, props } = tag;
  if (tagName === "title")
    return "0-title";
  if (tagName === "meta") {
    let priority = props.content === group && typeof props.property == "string" && !props.property.endsWith("secure_url") && "0";
    return [tagName, ...[group, priority], props.property || props.name].filter((x) => x).join("-");
  }
  return tagName === "link" ? [tagName, props.rel, props.hrefLang || props.media].filter((x) => x).join("-").replace(/\s+/g, "-") : tagName === "script" ? `${tagName}-${group}` : `${tagName}-${props.type}`;
}
...
var SeoLogger = (0, import_react5.lazy)(() => Promise.resolve().then(() => (init_log_seo_tags_URUAZSXD(), log_seo_tags_URUAZSXD_exports)));
function Seo({ debug }) {
  let matches = useMatches2(), location = useLocation(), seoConfig = (0, import_react5.useMemo)(() => matches.flatMap((match) => {
    var _a2;
    let { handle: handle2, ...routeMatch } = match, routeData = { ...routeMatch, ...location }, handleSeo = handle2 == null ? void 0 : handle2.seo, loaderSeo = (_a2 = routeMatch == null ? void 0 : routeMatch.data) == null ? void 0 : _a2.seo;
    return !handleSeo && !loaderSeo ? [] : handleSeo ? recursivelyInvokeOrReturn(handle2.seo, routeData) : [loaderSeo];
  }).reduce((acc, current) => {
    Object.keys(current).forEach(
      (key) => !current[key] && delete current[key]
    );
    let { jsonLd } = current;
    return jsonLd ? acc != null && acc.jsonLd ? Array.isArray(jsonLd) ? {
      ...acc,
      ...current,
  ...
  }, {}), [matches, location]), { html, loggerMarkup } = (0, import_react5.useMemo)(() => {
    let headTags = generateSeoTags(seoConfig), html2 = headTags.map((tag) => tag.tag === "script" ? (0, import_react5.createElement)(tag.tag, {
      ...tag.props,
      key: tag.key,
      dangerouslySetInnerHTML: { __html: tag.children }
    }) : (0, import_react5.createElement)(tag.tag, { ...tag.props, key: tag.key }, tag.children)), loggerMarkup2 = (0, import_react5.createElement)(
      import_react5.Suspense,
      { fallback: null },
      (0, import_react5.createElement)(SeoLogger, { headTags })
    );
    return { html: html2, loggerMarkup: loggerMarkup2 };
  }, [seoConfig]);
  return (0, import_react5.createElement)(import_react5.Fragment, null, html, debug && loggerMarkup);
}
function recursivelyInvokeOrReturn(value, ...rest) {
  if (value instanceof Function)
    return recursivelyInvokeOrReturn(value(...rest), ...rest);
  let result = {};
  return Array.isArray(value) ? (result = value.reduce((acc, item) => [...acc, recursivelyInvokeOrReturn(item)], []), result) : value instanceof Object ? (Object.entries(value).forEach(([key, val]) => {
...
function App() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("html", { lang: "en", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("head", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Seo, {}, void 0, !1, {
        fileName: "app/root.jsx",
        lineNumber: 44,
        columnNumber: 9
      }, this),
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("body", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Layout, { title: name, children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)(Outlet, {}, void 0, !1, {
        fileName: "app/root.jsx",
        lineNumber: 50,
        columnNumber: 11
      }, this) }, void 0, !1, {
...
function ProductCard({ product }) {
  var _a2;
  let { price, compareAtPrice } = ((_a2 = product.variants) == null ? void 0 : _a2.nodes[0]) || {}, isDiscounted = (compareAtPrice == null ? void 0 : compareAtPrice.amount) > (price == null ? void 0 : price.amount);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Link2, { to: `/products/${product.handle}`, children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "grid gap-6", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "shadow-sm rounded relative", children: [
      isDiscounted && /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("label", { className: "subpixel-antialiased absolute top-0 right-0 m-4 text-right text-notice text-red-600 text-xs", children: "Sale" }, void 0, !1, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "grid gap-1", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("h3", { className: "max-w-prose text-copy w-full overflow-hidden whitespace-nowrap text-ellipsis ", children: product.title }, void 0, !1, {
        fileName: "app/components/ProductCard.jsx",
        lineNumber: 23,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("div", { className: "flex gap-4", children: /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("span", { className: "max-w-prose whitespace-pre-wrap inherit text-copy flex gap-4", children: [
        /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Money, { withoutTrailingZeros: !0, data: price }, void 0, !1, {
          fileName: "app/components/ProductCard.jsx",
          lineNumber: 28,
          columnNumber: 15
        }, this),
        isDiscounted && /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(
          Money,
          {
...
function ProductGrid({ collection, url }) {
  let [nextPage, setNextPage] = (0, import_react10.useState)(
    collection.products.pageInfo.hasNextPage
  ), [endCursor, setEndCursor] = (0, import_react10.useState)(
    collection.products.pageInfo.endCursor
  ), [products, setProducts] = (0, import_react10.useState)(collection.products.nodes || []), fetcher = useFetcher2();
  ...
  return (0, import_react10.useEffect)(() => {
  ...
  }, [fetcher.data]), /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("section", { className: "w-full gap-4 md:gap-8 grid", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "grid-flow-row grid gap-2 gap-y-6 md:gap-4 lg:gap-6 grid-cols-2 md:grid-cols-3 lg:grid-cols-4", children: products.map((product) => /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(ProductCard, { product }, product.id, !1, {
    ...
    nextPage && /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)("div", { className: "flex items-center justify-center mt-6", children: /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(
      "button",
      {
...
// app/routes/collections.$handle.jsx
var import_jsx_dev_runtime6 = __toESM(require_jsx_dev_runtime()), seo = ({ data }) => {
  var _a2, _b;
  return {
    title: (_a2 = data == null ? void 0 : data.collection) == null ? void 0 : _a2.title,
    description: (_b = data == null ? void 0 : data.collection) == null ? void 0 : _b.description.substr(0, 154)
  };
}, handle = {
  seo
};
async function loader2({ params, context, request }) {
  let { handle: handle2 } = params, cursor = new URL(request.url).searchParams.get("cursor"), { collection } = await context.storefront.query(COLLECTION_QUERY, {
    variables: {
      handle: handle2,
      cursor
    }
...
function meta({ data }) {
  var _a2, _b;
  return [
    { title: ((_a2 = data == null ? void 0 : data.collection) == null ? void 0 : _a2.title) ?? "Collection" },
    { description: (_b = data == null ? void 0 : data.collection) == null ? void 0 : _b.description }
  ];
}
function Collection() {
  let { collection } = useLoaderData2();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(import_jsx_dev_runtime6.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("header", { className: "grid w-full gap-8 py-8 justify-items-start", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("h1", { className: "text-4xl whitespace-pre-wrap font-bold inline-block", children: collection.title }, void 0, !1, {
        fileName: "app/routes/collections.$handle.jsx",
        lineNumber: 50,
        columnNumber: 9
      }, this),
      collection.description && /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("div", { className: "flex items-baseline justify-between w-full", children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("p", { className: "max-w-md whitespace-pre-wrap inherit text-copy inline-block", children: collection.description }, void 0, !1, {
        fileName: "app/routes/collections.$handle.jsx",
        lineNumber: 57,
        columnNumber: 15
      }, this) }, void 0, !1, {
...
async function loader3({ params, context }) {
  let { handle: handle2 } = params, { product } = await context.storefront.query(PRODUCT_QUERY, {
    variables: {
      handle: handle2
    }
  });
...
function PrintJson({ data }) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("details", { className: "outline outline-2 outline-blue-300 p-4 my-2", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("summary", { children: "Product JSON" }, void 0, !1, {
      fileName: "app/routes/products.$handle.jsx",
      lineNumber: 25,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("pre", { children: JSON.stringify(data, null, 2) }, void 0, !1, {
      fileName: "app/routes/products.$handle.jsx",
      lineNumber: 26,
      columnNumber: 7
    }, this)
...
function ProductHandle() {
  let { handle: handle2, product } = useLoaderData2();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "product-wrapper", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(PrintJson, { data: product }, void 0, !1, {
      fileName: "app/routes/products.$handle.jsx",
      lineNumber: 37,
      columnNumber: 7
    }, this)
...
async function loader4({ context }) {
  return await context.storefront.query(COLLECTIONS_QUERY);
}
function Index() {
  let { collections } = useLoaderData2();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("section", { className: "w-full gap-4", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("h2", { className: "whitespace-pre-wrap max-w-prose font-bold text-lead", children: "Collections" }, void 0, !1, {
      fileName: "app/routes/_index.jsx",
      lineNumber: 19,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("div", { className: "grid-flow-row grid gap-2 gap-y-6 md:gap-4 lg:gap-6 grid-cols-1 sm:grid-cols-3", children: collections.nodes.map((collection) => /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)(Link2, { to: `/collections/${collection.handle}`, children: /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("div", { className: "grid gap-4", children: [
      (collection == null ? void 0 : collection.image) && /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)(
        Image,
        {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)("h2", { className: "whitespace-pre-wrap max-w-prose font-medium text-copy", children: collection.title }, void 0, !1, {
        fileName: "app/routes/_index.jsx",
        lineNumber: 40,
        columnNumber: 17
      }, this)
...
function Layout2(props) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "hydrogen-virtual-route", children: props.children }, void 0, !1, {
...
// node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx
var import_jsx_dev_runtime10 = __toESM(require_jsx_dev_runtime(), 1), links2 = () => [
...
function App2() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("html", { lang: "en", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("head", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("title", { children: "Hydrogen" }, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 22,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("meta", { name: "description", content: "A custom storefront powered by Hydrogen" }, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 23,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(Meta, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 24,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(Links, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 25,
        columnNumber: 7
      }, this)
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("body", { children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(Layout2, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(Outlet, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 28,
        columnNumber: 15
      }, this) }, void 0, !1, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(ScrollRestoration2, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 29,
        columnNumber: 7
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(Scripts, {}, void 0, !1, {
        fileName: "node_modules/@shopify/cli-hydrogen/dist/virtual-routes/virtual-root.jsx",
        lineNumber: 30,
        columnNumber: 7
      }, this)
...
var assets_manifest_default = { entry: { module: "/build/entry.client-YYVW6Z3H.js", imports: ["/build/_shared/chunk-R5BP3EWW.js", "/build/_shared/chunk-IU43IUTG.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-7P565AFZ.js", imports: ["/build/_shared/chunk-YE2TYU3M.js"], hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/_index": { id: "routes/_index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/_index-7V7AFLWB.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/collections.$handle": { id: "routes/collections.$handle", parentId: "root", path: "collections/:handle", index: void 0, caseSensitive: void 0, module: "/build/routes/collections.$handle-ZWK5U5DU.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/products.$handle": { id: "routes/products.$handle", parentId: "root", path: "products/:handle", index: void 0, caseSensitive: void 0, module: "/build/routes/products.$handle-7PY5B6PU.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "virtual-routes/routes/graphiql": { id: "virtual-routes/routes/graphiql", parentId: "virtual-routes/virtual-root", path: "graphiql", index: void 0, caseSensitive: void 0, module: "/build/virtual-routes/routes/graphiql-2PLOBUIK.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "virtual-routes/virtual-root": { id: "virtual-routes/virtual-root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/virtual-routes/virtual-root-SSANLPX4.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, version: "718dccff", hmr: void 0, url: "/build/manifest-718DCCFF.js" };

// server-entry-module:@remix-run/dev/server-build
var assetsBuildDirectory = "dist/client/build", future = { unstable_dev: !1, unstable_postcss: !1, unstable_tailwind: !1, v2_errorBoundary: !0, v2_headers: !0, v2_meta: !0, v2_normalizeFormMethod: !0, v2_routeConvention: !0 }, publicPath = "/build/", entry = { module: entry_server_exports }, routes = {
  root: {
    id: "root",
    parentId: void 0,
    path: "",
...
@remix-run/server-runtime/dist/esm/warnings.js:
  (**
   * @remix-run/server-runtime v1.17.1
   *
   * Copyright (c) Remix Software Inc.
   *
   * This source code is licensed under the MIT license found in the
